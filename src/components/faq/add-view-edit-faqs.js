...
import BurgerNavigation from "../navigation/burger-navigation"
 ...
 function FAQCRUD() {
  ...
  var columns=[
    { title: 'Video Status', field: 'videostatus' ,type: 'boolean', initialEditValue: false},
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    ...
    if(errorList.length < 1){
        FaqService.update(newData._id, newData)
