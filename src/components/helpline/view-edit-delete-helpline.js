...
import BurgerNavigation from "../navigation/burger-navigation"
 ...
 function HelplineRUD() {
  ...
  var columns=[
    ...
    { title: 'Response Status', field: 'responsestatus' ,type: 'boolean', },
  ...
  const handleRowUpdate = (newData, oldData, resolve) => {
    ...
    if(errorList.length < 1){
        HelplineService.update(newData._id, newData)
  ...
  const handleRowDelete = (oldData, resolve) => {
    ...
    HelplineService.delete(oldData._id)
  ...
  return (
    ...
    <Grid container spacing={1}>
     ...
     <MaterialTable
          title="Response Helpline Information"
            columns={columns}
            data={data}
             editable={{
